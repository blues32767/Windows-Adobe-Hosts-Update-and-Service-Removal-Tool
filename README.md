...
10. **封鎖 Adobe 相關可執行文件的防火牆規則 / Block Adobe-related Executables in Firewall**
...
- **2025-04-20**:
  ...
  - **版本 / Version**: v3.20250420
  - **修正**: 修復防火牆功能中的語法錯誤，確保腳本穩定執行。
  - **Fix**: Fixed syntax error in firewall functionality to ensure stable execution.